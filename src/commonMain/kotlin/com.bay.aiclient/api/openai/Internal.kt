...
data class OpenAiHttpChatResponseFormat(
    ...
    companion object {
        fun from(genericResponseFormat: GenerateTextRequest.ResponseFormat?): OpenAiHttpChatResponseFormat? =
            when (genericResponseFormat?.type) {
                null -> null
                GenerateTextRequest.ResponseFormat.Type.TEXT -> OpenAiHttpChatResponseFormat("text", null)
                GenerateTextRequest.ResponseFormat.Type.JSON_OBJECT -> OpenAiHttpChatResponseFormat("json_object")

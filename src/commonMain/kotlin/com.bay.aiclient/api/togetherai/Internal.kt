...
data class TogetherAiHttpChatResponseFormat(
    ...
    companion object {
        fun from(genericResponseFormat: GenerateTextRequest.ResponseFormat?): TogetherAiHttpChatResponseFormat? =
            when (genericResponseFormat?.type) {
                null, GenerateTextRequest.ResponseFormat.Type.TEXT -> null
                GenerateTextRequest.ResponseFormat.Type.JSON_OBJECT -> TogetherAiHttpChatResponseFormat("json_object")
